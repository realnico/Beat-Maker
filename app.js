...
drumKits.playBtn.addEventListener("click", () => {
    drumKits.start();
});

drumKits.playBtn.onclick = function() {
...
drumKits.tempoSlider.addEventListener("input", (e) => {
    drumKits.changeTempo(e);
});

drumKits.tempoSlider.addEventListener("input", (e) =>  {
    drumKits.updateTempo(e);
});